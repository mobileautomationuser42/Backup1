Feature: Verify Personal details sections.

 @TRKDW-157 @regression
  Scenario: TRKDW-157 - Verify the fields present in the Domestic Worker Personal details sections
     Given user logged into DubaiNow application
		 ...
		 Then user redirects to personal details page and verifying first section containing below elements 
		 	...
		 	| Middle Name |
		 	| Last Name   |
		 And verifying second section containing below elements 
		 	|  Section 2       |
		 	| Nationality      |
		 	| Job              |
		 	| Gender           |
	...
	@TRKDW-207 @regression
  Scenario: TRKDW-207 - Verify the entered field value persist in Personal details sections
     Given user logged into DubaiNow application
		 When user clicks on Residency tab and click on domestic worker
		 Then user clicks on New Application button
		 And user verifying below elements are present on application page 
	...
	@TRKDW-160 @regression
  Scenario: TRKDW-160 - Verify the mandatory fields in the Domestic Worker Personal details sections
     Given user logged into DubaiNow application
		 When user clicks on Residency tab and click on domestic worker
		 Then user clicks on New Application button
		 And user verifying below elements are present on application page 
  ...
  @TRKDW-159 @regression
  Scenario: TRKDW-159 - Validating the fields in the Domestic Worker Personal details sections
     Given user logged into DubaiNow application
		 When user clicks on Residency tab and click on domestic worker
		 Then user clicks on New Application button
		 And user verifying below elements are present on application page 
